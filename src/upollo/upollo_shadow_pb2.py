...
PLATFORM_UPOLLO_SITE = 90
PLATFORM_WEBHOOK_STRIPE = 100


_LIBRARY = DESCRIPTOR.message_types_by_name['Library']
_DNSSIGNAL = DESCRIPTOR.message_types_by_name['DNSSignal']
...
DNSSignal = _reflection.GeneratedProtocolMessageType('DNSSignal', (_message.Message,), {
  'DESCRIPTOR' : _DNSSIGNAL,
  '__module__' : 'upollo.upollo_shadow_pb2'
  # @@protoc_insertion_point(class_scope:uwGrpc.DNSSignal)
  })
_sym_db.RegisterMessage(DNSSignal)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\016ai.upollo.grpcP\001Z(github.com/userwatch/uw1/protos/pbshadow\242\002\006UpGrpc'
  _PLATFORM._serialized_start=231
  _PLATFORM._serialized_end=481
  _LIBRARY._serialized_start=71
  _LIBRARY._serialized_end=149
  _DNSSIGNAL._serialized_start=151
  _DNSSIGNAL._serialized_end=228
